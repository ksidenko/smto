 ...
 * @since 1.0
 */
class P2ModelCommand extends CConsoleCommand {
...
EOD;
    ...
    protected function generateRelations() {
        ...
        foreach($this->_schema->getTables() as $table) {
            ...
            if ($this->isRelationTable($table)) {
                ...
                $this->_relations[$className0][$relationName]="array(self::MANY_MANY, '$className1', '$unprefixedTableName($pks[1], $pks[0])')";
	...
	public function run($args)
	{
        ...
        $this->templatePath = realpath(dirname(__FILE__).DS.'..'.DS.'..'.DS.'views'.DS.'shell'.DS.'model');
