 ...
 * Class File
 *
 * Derived from ApiCommand from yii/build
 *
...
/**
 * Command, creates this documentation
 *
 * @author Tobias Munk <schmunk@usrbin.de>
 * @version $Id: ApiCommand.php 511 2010-03-24 00:41:52Z schmunk $
 * @package p2.cli.commands
 * @since 2.0
 */
Yii::import('application.modules.p2.commands.api.ApiModel');
...
class ApiCommand extends CConsoleCommand
{
	...
	public function getHelp()
	{
		return <<<EOD
USAGE
  yiic api <output-path> [mode]

DESCRIPTION
  This command generates offline API documentation for p2.
...
EOD;
	...
	public function run($args)
	{
		...
		$this->pageTitle='Phundament Class Reference';
		$themePath=dirname(__FILE__).'/api';

                $path = realpath(dirname(__FILE__).DIRECTORY_SEPARATOR.'..');
                Yii::setPathOfAlias('p2', $path);
		$model=$this->buildModel($path,$options);
