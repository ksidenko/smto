...
class <?php echo $controllerClass; ?> extends CController
{
	...
	/**
	 * @var string specifies the layout.
	 */
    public $layout='p2.views.layouts.main';
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','create','ajaxCreate','update'),
		...
		if(isset($_POST['<?php echo $modelClass; ?>']))
		{
                    ...
                    if (Yii::app()->request->isAjaxRequest) {
                        ...
                        if(P2Helper::return_url()) {
                            ...
                            $this->redirect(array('show','id'=>$model-><?php echo $ID; ?>, 'return_url' => P2Helper::return_url()));
                        }
                    }
		}
	...
	public function actionDelete()
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			try {
                            $this->load<?php echo $modelClass; ?>($_REQUEST['<?php echo $ID ?>'])->delete();
                        } catch (Exception $e) {
                            $error = $e->getMessage();
                        }
	...
	public function actionAdmin()
	{
		...
		$criteria=new CDbCriteria;
                if(isset($_GET['<?php echo $modelClass; ?>'])) foreach($_GET['<?php echo $modelClass; ?>'] AS $column => $term) {
                    if(!empty($term)) $criteria->addSearchCondition($column,$term,'OR');
                }
