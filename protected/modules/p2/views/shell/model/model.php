...
class <?php echo $className; ?> extends <?php echo (Yii::app()->params['p2.crud.baseModel'])?Yii::app()->params['p2.crud.baseModel']:'CActiveRecord' ?>
{
	/**
...
<?php endforeach; ?>
			...
			array('<?php echo implode(', ', array_keys($columns)); ?>', 'safe', 'on'=>'search'),
                        ...
                        // Rules for relations
                        array('<?php echo implode(', ', array_keys($relations)); ?>', 'safe'),
		);
	}
