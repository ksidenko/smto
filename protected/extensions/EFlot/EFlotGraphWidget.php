...
class EFlotGraphWidget extends EFlotWidget
{
	...
	public function run()
	{
        ...
        Yii::app()->getClientScript()->registerScript(__CLASS__.'#'.$id,"if ($.plot_data == null ) { $.plot_data = {}; } $.plot_data['${id}'] = $.plot($placeholder, $flotdata, $flotoptions);", CClientScript::POS_READY);
	}
